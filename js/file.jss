...
const dayWeekNames = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday",];// The days of the week
const maleAkanNames = ["Kwasi","Kwadwo","Kwabena","Kwaku","Yaw","Kofi","Kwame",];// the male Akan Names as per days of the week
const femaleAkanNames = ["Akosua","Adwoa","Abenaa","Akua","Yaa","Afua","Ama",];// the female Akan Names as per days of the week

//This function validates the date,month,year and gender to give correct output
function validate() {
  ...
  if (document.myForm.year.value == "" ||document.myForm.year.value.length != 4 ||document.myForm.year.value > 2022 ||document.myForm.year.value <= 1900) 
     ...
     return false;
      ...
      (document.myForm.month.value == ""||isNaN(document.myForm.month.value) ||document.myForm.month.value.length != 2 ||document.myForm.month.value > 12 ||document.myForm.month.value <=0) 
     {
    alert("Please provide the month you were born! between 1 and 12");
...
//The function calcultes the day value
...
//The function gets the gender either male/female,checks when the male/female was born and compares with the day value so that it can output the name of male/female
function getGender() {
  var genders = document.getElementsByName("gender");
...
//The function outputs the name,calculates day value then gives the results when a male/female was born and day.If not correct,user is prompted to enter the values afresh.
function findName(){
  ...
  if (dataIsValid) {
    ...
    alert("Wrong Data Entry!, Enter correct Day, Month and Year");
  }
}